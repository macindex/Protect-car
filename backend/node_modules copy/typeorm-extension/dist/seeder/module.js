        ...
        if (options.factories) {
            ...
            if (factoryFiles.length > 0) {
                ...
                for (let i = 0; i < factoryFiles.length; i++) {
                    yield (0, locter_1.loadScriptFile)(factoryFiles[i]);
                }
            }
        ...
        if (options.seeds) {
            ...
            if (seedFiles.length > 0) {
                ...
                for (let i = 0; i < seedFiles.length; i++) {
                    const fileExport = yield (0, locter_1.loadScriptFileExport)(seedFiles[i]);
                    if (fileExport) {
...
function runSeeder(dataSource, seeder, options) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const factoryManager = (0, factory_1.useSeederFactoryManager)();
        yield clazz.run(dataSource, factoryManager);
    });
}
...
function runSeeders(dataSource, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < items.length; i++) {
            yield runSeeder(dataSource, items[i], {
                factoriesLoad: false,
            });
        }
    });
