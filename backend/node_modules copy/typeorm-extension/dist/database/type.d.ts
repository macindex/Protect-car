...
export declare type DatabaseBaseContext = {
    /**
...
export declare type DatabaseCreateContext = DatabaseBaseContext & {
    /**
...
export declare type DatabaseDropContext = DatabaseBaseContext & {
    /**
